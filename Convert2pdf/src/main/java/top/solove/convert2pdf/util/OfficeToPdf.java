...
public class OfficeToPdf {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            urlConnection.setConnectTimeout(60 * 100);
    ...
    public static void office2pdf(InputStream in, String outputFilePath, String fileName) {
        ...
        try {
            ...
            officeManager = LocalOfficeManager.builder().officeHome(officeHome)
                    ...
                    .taskQueueTimeout(60 * 1000 * 26)
                    .taskExecutionTimeout(60 * 1000 * 10).install().build();
            // 启动转换服务
            officeManager.start();
    ...
    private static DocumentFormat getSuffix(String fileName) {
    ...
    public static void setWatermark(BufferedOutputStream bos, String input, String waterMarkName) {
        ...
        try {
            ...
            textH = ((FontMetrics) metrics).getHeight();
            ...
            for (int i = 1; i < total; i++) {
                ...
                // 设置字体和字体大小
                content.beginText();
                content.setFontAndSize(base, 10 * 2);
                // 获取每一页的高度、宽度
    ...
    private static int getFontSize(String waterMarkName) {
        ...
        if (null != waterMarkName && !"".equals(waterMarkName)) {
            ...
            if (length <= NUM_26 && length >= 9 * 2) {
                fontSize = NUM_26;
            } else if (length < 9 * 2 && length >= 8) {
                fontSize = 40;
